...
<div class="slider-area-wrapper">
    <div class="slider-content-active">
        <div class="slider-slide-item bg-img" data-bg="{{ asset('public/assets/img/slider/slider-1.jpg') }}">
        ...
        <div class="slider-slide-item bg-img" data-bg="{{ asset('public/assets/img/slider/slider-2.jpg') }}">
            <div class="container container-wide h-100">
                <div class="row align-items-center h-100">
                    <div class="col-12">
                        <div class="slide-content">
    ...
    <div class="container container-wide">
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="banner-item">
                    <div class="banner-item__img">
                        <a href="#"><img src="{{ asset('public/assets/img/banner/banner-1.jpg') }}"
                                alt="Banner" /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner-item">
                    <div class="banner-item__img">
                        <a href="#"><img src="{{ asset('public/assets/img/banner/banner-2.jpg') }}"
                                alt="Banner" /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner-item">
                    <div class="banner-item__img">
                        <a href="#"><img src="{{ asset('public/assets/img/banner/banner-3.jpg') }}"
                                alt="Banner" /></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="product-carousel">
                            ...
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-1.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-2.png') }}" alt="Product" />
                                </a>
                            </div>
                        ...
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-3.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-4.png') }}" alt="Product" />
                                </a>
                            </div>
                            ...
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-4.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-5.png') }}" alt="Product" />
                                </a>
                            </div>
...
<div class="call-to-action-area">
    <div class="call-to-action-content-area bg-img" data-bg="{{ asset('public/assets/img/bg/bg-1.jpg') }}">
        <div class="container">
            <div class="row">
    ...
    <div class="call-to-action-image-area">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <img src="{{ asset('public/assets/img/bg/bg-car.png') }}" alt="Car" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="promotion-code-banner-item mb-sm-30">
                    <img src="{{ asset('public/assets/img/banner/banner-5.jpg') }}" alt="Banner" />
                </div>
            </div>

            <div class="col-md-6">
                <div class="promotion-code-banner-item">
                    <img src="{{ asset('public/assets/img/banner/banner-6.jpg') }}" alt="Banner" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-6.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-7.png') }}" alt="Product" />
                                </a>
                            </div>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-8.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-9.png') }}" alt="Product" />
                                </a>
                            </div>
                            ...
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-7.png') }}" alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-14.png') }}"
                                        alt="Product" />
                                </a>
                            </div>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-10.png') }}"
                                        alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-5.png') }}" alt="Product" />
                                </a>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-11.png') }}"
                                        alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-4.png') }}" alt="Product" />
                                </a>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-13.png') }}"
                                        alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-12.png') }}"
                                        alt="Product" />
                                </a>
                            </div>
                    ...
                    <div class="col">
                        <div class="product-item">
                            <div class="product-item__thumb">
                                <a href="single-product.html">
                                    <img class="thumb-primary"
                                        src="{{ asset('public/assetsimg/product/product-15.png') }}"
                                        alt="Product" />
                                    <img class="thumb-secondary"
                                        src="{{ asset('public/assetsimg/product/product-4.png') }}" alt="Product" />
                                </a>
...
<div class="flash-deals-area bg-img" data-bg="{{ asset('public/assets/img/bg/deal-bg.jpg') }}">
    <div class="container">
        <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5 col-lg-6">
                        <div class="flash-deals-thumb text-center text-md-start">
                            <img src="{{ asset('public/assets/img/extra/wheels.png') }}" alt="Deals" />
                        </div>
                    </div>
...
<div class="newsletter-area-wrapper">
    <div class="container container-wide">
        <div class="newsletter-area-inner bg-img" data-bg="{{ asset('public/assets/img/bg/newsletter-bg.jpg') }}">
            <div class="row">
            ...
            <div class="col-12">
                <div class="brand-logo-content">
                    <div class="brand-logo-item">
                        <a href="#"><img src="{{ asset('public/assets/img/brand-logo/brand-1.png') }}"
                                alt="Logo" /></a>
                    </div>

                    <div class="brand-logo-item">
                        <a href="#"><img src="{{ asset('public/assets/img/brand-logo/brand-2.png') }}"
                                alt="Logo" /></a>
                    </div>

                    <div class="brand-logo-item">
                        <a href="#"><img src="{{ asset('public/assets/img/brand-logo/brand-3.png') }}"
                                alt="Logo" /></a>
                    </div>

                    <div class="brand-logo-item">
                        <a href="#"><img src="{{ asset('public/assets/img/brand-logo/brand-4.png') }}"
                                alt="Logo" /></a>
                    </div>

                    <div class="brand-logo-item">
                        <a href="#"><img src="{{ asset('public/assets/img/brand-logo/brand-5.png') }}"
                                alt="Logo" /></a>
                    </div>
