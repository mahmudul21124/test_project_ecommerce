                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <ul class="nav nav-pills-custom nav-pills mb-0" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-browser-tab" data-toggle="pill" href="#Browser_Used"
                                    role="tab" aria-controls="pills-browser" aria-selected="false">Browser
                                    Used</a>
                            </li>
                        </ul>
                    </div><!--end col-->
                    ...
                    <div class="tab-pane fade show active" id="Traffic_Sources" role="tabpanel"
                        ...
                        <div class="table-responsive browser_users">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="" class="text-primary">Organic search</a>
                                        </td>
                    ...
                    <div class="tab-pane fade" id="Browser_Used" role="tabpanel"
                        ...
                        <div class="table-responsive browser_users">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="{{ asset('public/back/admin/assets/images/browser_logo/chrome.png') }}"
                                                alt="" height="24" class="mr-2">Chrome
                                        </td>
                                        <td>10853<small class="text-muted">(52%)</small></td>
                                        <td> 52.80%</td>
                                        <td>566<small class="text-muted">(92%)</small></td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('public/back/admin/assets/images/browser_logo/micro-edge.png') }}"
                                                alt="" height="24" class="mr-2">Microsoft Edge</td>
                                        <td>2545<small class="text-muted">(47%)</small></td>
                                        <td> 47.54%</td>
                                        <td>498<small class="text-muted">(81%)</small></td>
                                    </tr><!--end tr-->
                                    <tr>
                                        <td><img src="{{ asset('public/back/admin/assets/images/browser_logo/in-explorer.png') }}"
                                                alt="" height="24" class="mr-2">Internet-Explorer</td>
                                        <td>1836<small class="text-muted">(38%)</small></td>
                                        <td> 41.12%</td>
                                        <td>455<small class="text-muted">(74%)</small></td>
                                    </tr><!--end tr-->
                                    <tr>
                                        <td><img src="{{ asset('public/back/admin/assets/images/browser_logo/opera.png') }}"
                                                alt="" height="24" class="mr-2">Opera
                                        </td>
                                        <td>1958<small class="text-muted">(31%)</small></td>
                                        <td> 36.82%</td>
                                        <td>361<small class="text-muted">(61%)</small></td>
            ...
            <div class="card-body">
                <ul class="list-group custom-list-group mb-n3">
                    <li class="list-group-item align-items-center d-flex justify-content-between">
                        <div class="media">
                            <img src="{{ asset('public/back/admin/assets/images/small/img-2.jpg') }}" height="40"
                    ...
                    <li class="list-group-item align-items-center d-flex justify-content-between">
                        <div class="media">
                            <img src="{{ asset('public/back/admin/assets/images/small/img-1.jpg') }}" height="40"
                                class="mr-3 align-self-center rounded" alt="...">
                            <div class="media-body align-self-center">
                    ...
                    <li class="list-group-item align-items-center d-flex justify-content-between">
                        <div class="media">
                            <img src="{{ asset('public/back/admin/assets/images/small/img-4.jpg') }}" height="40"
                                class="mr-3 align-self-center rounded" alt="...">
                            <div class="media-body align-self-center">
                    ...
                    <li class="list-group-item align-items-center d-flex justify-content-between">
                        <div class="media">
                            <img src="{{ asset('public/back/admin/assets/images/small/img-5.jpg') }}" height="40"
                                class="mr-3 align-self-center rounded" alt="...">
                            <div class="media-body align-self-center">
            ...
            <div class="card-body">
                <div class="analytic-dash-activity" data-simplebar>
                    <div class="activity">
                        ...
                        <div class="activity-info">
                            <div class="icon-info-activity">
                                <img src="{{ asset('public/back/admin/assets/images/users/user-5.jpg') }}"
                        ...
                        <div class="activity-info">
                            <div class="icon-info-activity">
                                <img src="{{ asset('public/back/admin/assets/images/users/user-4.jpg') }}"
                                    alt="" class="rounded-circle thumb-md">
                            </div>
                            <div class="activity-info-text">
                                <div class="d-flex justify-content-between align-items-center">
